...
## Introduction
A 3 Hour threat modelling workshop took place to detail the runbook scenario of multiple AI attacks against the web-facing Oracle E-Business Suite application..

## Attendess
Desicon OracleEBS Eng team, Product Managers, DevEx Engineers and the DevSecOps Team.
